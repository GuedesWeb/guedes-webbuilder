...
body{font-family:var(--fonte-corpo);color:var(--cor-texto);background:var(--cor-fundo);line-height:1.6;overflow-x:hidden;font-weight:400;font-size:16px;-webkit-font-smoothing:antialiased;text-wrap:pretty}
img{max-width:100%;height:auto;display:block}
a{text-decoration:none;color:inherit}
ul{list-style:none}
h1,h2,h3,h4,p,blockquote,li{text-wrap:pretty}

.container{max-width:1200px;margin:0 auto;padding:0 24px}
.section{padding:80px 0}
@media(max-width:768px){.section{padding:56px 0}}

.display{font-family:var(--fonte-display);font-weight:600;letter-spacing:-.01em;line-height:1.12;text-wrap:balance}
...
function next(){if(cur===total){cur=total+1;track.style.transition='transform .5s ease';track.style.transform='translateX(-'+(cur*(100/total))+'%)';updateDots(0);resetAuto();}else{goTo((cur)%total);}}
function prev(){if(cur===1){cur=0;track.style.transition='transform .5s ease';track.style.transform='translateX(-'+(cur*(100/total))+'%)';updateDots(total-1);resetAuto();}else{goTo((cur-2+total)%total);}}
